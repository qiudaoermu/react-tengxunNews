...
var NavsContent = function (_React$Component) {
    ...
    _createClass(NavsContent, [{
        ...
        value: function handleClick(item, index) {
            console.log(item.id + "," + index.target.getAttribute('data-bb'));
        }
    }, {
        key: "render",
            ...
            return _react2.default.createElement(
                ...
                this.props.config.map(function (item, index) {
                    if (item.art_type == 1) {
                        return _react2.default.createElement(
                            "div",
                            { className: "imgsCon", ref: "imgJump", key: index, "data-bb": item.id,
...
//# sourceMappingURL=0.4b8aef7326779f88f7a9.hot-update.js.map