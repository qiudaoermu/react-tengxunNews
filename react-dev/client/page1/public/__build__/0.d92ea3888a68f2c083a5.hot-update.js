...
var WordImg = function (_React$Component) {
    ...
    _createClass(WordImg, [{
        ...
        value: function showImgReal(index) {
            return this.state.realShow ? "sharBoard-active" : "sharBoard";
        }
    }, {
        key: 'render',
                ...
                this.state.newsData.map(function (item, index) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { onMouseOver: _this3.showImg.bind(_this3), index: index, className: 'shareButton' },
...
//# sourceMappingURL=0.d92ea3888a68f2c083a5.hot-update.js.map