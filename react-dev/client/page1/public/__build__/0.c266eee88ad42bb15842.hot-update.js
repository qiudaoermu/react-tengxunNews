    ...
    _createClass(WordImg, [{
        ...
        value: function componentDidMount() {
            ...
            document.body.addEventListener('mouseout', function (e) {
                ...
                //     return;
                // }
                // console.log('通过e.target判断阻止冒泡');
                console.log("阻止冒泡");
                _this3.setState({ realShow: "400" });
                return;
            });
        }
    }, {
                ...
                this.state.newsData.map(function (item, index) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { onMouseOver: _this4.showImg.bind(_this4),
                                    onMouseOut: _this4.hideImg.bind(_this4),
                                    data: index, className: 'shareButton' },
                                _react2.default.createElement(
                                    'div',
                                    {
                                        className: _this4.showImgReal(index),
                                        onMouseOver: _this4.stopParation.bind(_this4)
...
//# sourceMappingURL=0.c266eee88ad42bb15842.hot-update.js.map