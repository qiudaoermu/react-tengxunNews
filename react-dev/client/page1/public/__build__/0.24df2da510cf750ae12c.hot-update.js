...
var WordImg = function (_React$Component) {
    ...
    _createClass(WordImg, [{
        ...
        value: function showImgReal(index) {
            return realShow ? "shareButton-active" : "shareButton";
        }
    }, {
        key: 'render',
                ...
                this.state.newsData.map(function (item, index) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('div', { onmouseenter: this.showImg.bind(this), className: this.showImgReal(index) })
                        )
                    );
                })
            );
...
//# sourceMappingURL=0.24df2da510cf750ae12c.hot-update.js.map