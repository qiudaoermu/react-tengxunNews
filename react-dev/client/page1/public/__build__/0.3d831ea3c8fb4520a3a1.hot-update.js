...
var NavsContent = function (_React$Component) {
    ...
    _createClass(NavsContent, [{
        ...
        key: "handleClick",
        value: function handleClick(item, index) {
            console.log(item + "," + index.target.getAttribute("data"));
        }
    }, {
        key: "handleClickTextAndImg",
        value: function handleClickTextAndImg(item, index) {
            console.log(item + "," + index.target.getAttribute("data"));
        }
    }, {
        key: "render",
            ...
            return _react2.default.createElement(
                ...
                this.props.config.map(function (item, index) {
                    if (item.art_type == 1) {
                        ...
                        return _react2.default.createElement(
                            "div",
                            (_React$createElement = { key: index,
                                className: "newsImg"
                            }, _defineProperty(_React$createElement, "key", index), _defineProperty(_React$createElement, "data-bb", item.id), _defineProperty(_React$createElement, "Click", function Click(item, index) {
                                _this2.handleClickTextAndImg(item, index);
...
//# sourceMappingURL=0.3d831ea3c8fb4520a3a1.hot-update.js.map