...
var WordImg = function (_React$Component) {
    ...
    _createClass(WordImg, [{
        ...
        value: function showImgReal(index) {
            return this.state.realShow ? "shareButton-active" : "shareButton";
        }
    }, {
        key: 'render',
                ...
                this.state.newsData.map(function (item, index) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { onMouseEnter: _this3.showImg.bind(_this3), className: _this3.showImgReal(index) },
                                _react2.default.createElement('div', { className: 'sharBoard' })
                            )
                        )
                    );
                })
...
//# sourceMappingURL=0.470f42553aa1fb94c1c8.hot-update.js.map