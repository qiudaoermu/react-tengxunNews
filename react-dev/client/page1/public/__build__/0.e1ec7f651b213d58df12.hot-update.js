...
var WordImg = function (_React$Component) {
    ...
    _createClass(WordImg, [{
        ...
        value: function showImg(event) {
            console.log("open");
            if (event.target.getAttribute("data") != this.state.second[0]) {
                this.setState({ flag: true });
            }
            this.state.first = event.target.getAttribute("data");
            ...
            this.state.second[0] = event.target.getAttribute("data");
        }
    }, {
        key: 'showImgReal',
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('div', { className: _this3.showImgReal(index), style: { display: _this3.state.realShow } })
                            )
                        )
                    );
                })
...
//# sourceMappingURL=0.e1ec7f651b213d58df12.hot-update.js.map