...
var NavsContent = function (_React$Component) {
    ...
    _createClass(NavsContent, [{
        ...
        value: function JumpImgCorese(event) {
            ...
            console.log(index);
            console.log(this.refs.imgJump.getAttribute("data-index="));
        }
    }, {
        key: "render",
            ...
            return _react2.default.createElement(
                ...
                this.props.config.map(function (item, index) {
                    if (item.art_type == 1) {
                        return _react2.default.createElement(
                            "div",
                            { className: "imgsCon", ref: "imgJump", key: index, "data-index": index, onClick: _this2.JumpImgCorese.bind(_this2) },
...
//# sourceMappingURL=0.6b90bd94dd6ff4b6cee0.hot-update.js.map