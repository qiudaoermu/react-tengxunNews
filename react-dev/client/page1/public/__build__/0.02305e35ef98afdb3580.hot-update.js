...
var NewsNavS = function (_React$Component) {
    ...
    _createClass(NewsNavS, [{
        ...
        value: function contentClass(val, index) {
            return index == this.state.current ? "nav_ContentActive" : ":";
        }
    }, {
        key: "changeNavItemHandle",
        value: function changeNavItemHandle(e) {
            if (e.target.className != 'nav_ContentActive') {
                return;
            }
            e.stopPropagation();
                    ...
                    this.state.list.map(function (val, index) {
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_componentNavsContent2.default, null)
                            )
                        );
                    })
                )
...
//# sourceMappingURL=0.02305e35ef98afdb3580.hot-update.js.map