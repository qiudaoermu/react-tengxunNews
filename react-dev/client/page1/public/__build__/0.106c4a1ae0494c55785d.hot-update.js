...
var NavsContent = function (_React$Component) {
    ...
    _createClass(NavsContent, [{
        ...
        value: function JumpImgCorese(event) {
            ...
            console.log(JSON.stringify(this.refs.imgJump.getAttribute("data-bb")));
        }
    }, {
        key: "render",
            ...
            return _react2.default.createElement(
                ...
                this.props.config.map(function (item, index) {
                    if (item.art_type == 1) {
                        return _react2.default.createElement(
                            "div",
                            { className: "imgsCon", ref: "imgJump", key: index, "data-bb": item, onClick: _this2.JumpImgCorese.bind(_this2) },
...
//# sourceMappingURL=0.106c4a1ae0494c55785d.hot-update.js.map